...
import { connectDB, validateMongoDatabaseName } from "../src/db.js";
...
if (process.env.RESTORE_DATABASE_NAME) {
  validateMongoDatabaseName(process.env.RESTORE_DATABASE_NAME);
  process.env.MONGO_DATABASE_NAME = process.env.RESTORE_DATABASE_NAME;
}
