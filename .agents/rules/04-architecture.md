...
5. **Infraestructura**:
   - La solución debe ejecutarse en contenedores Docker para asegurar consistencia entre desarrollo, pruebas y despliegue (Ver `.agents/rules/09-docker-infrastructure.md`).
