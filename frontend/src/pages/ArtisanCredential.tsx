      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-black tracking-tight leading-tight py-2">
            {t("credential.title")} <span className="text-primary italic">{t("credential.titleAccent")}</span>
          </h1>
          ...
          <CardContent className="p-8 md:p-12 space-y-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-display font-bold">{t("credential.certTitle")}</h3>
                  <p className="text-sm text-muted-foreground font-medium">{t("credential.certReg")} TC-2024-PAN-088</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <h4 className="text-sm font-black uppercase tracking-widest text-primary/70">{t("credential.standardsTitle")}</h4>
                <ul className="space-y-4">
                  {[
                    t("credential.standard1"),
                    t("credential.standard2"),
                    t("credential.standard3"),
                    t("credential.standard4")
                  ].map((item, i) => (
              ...
              <div className="bg-muted/30 rounded-[1.5rem] p-8 space-y-4 border border-border/20">
                <div className="flex items-center gap-2 text-primary font-bold text-sm">
                  ...
                  <span>{t("credential.originTitle")}</span>
                </div>
                <p className="text-sm leading-relaxed text-muted-foreground italic">
                  {t("credential.originText")}
                </p>
                <div className="pt-4 flex justify-between items-end">
                  <div className="space-y-1">
                    <p className="text-[10px] uppercase font-bold text-muted-foreground/60">{t("credential.signatureTitle")}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-12">
          {[
            {
              title: t("credential.benefit1Title"),
              desc: t("credential.benefit1Desc")
            },
            {
              title: t("credential.benefit2Title"),
              desc: t("credential.benefit2Desc")
            },
            {
              title: t("credential.benefit3Title"),
              desc: t("credential.benefit3Desc")
            }
          ].map((benefit, i) => (
