        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-black tracking-tight leading-relaxed py-2">
              Mi Historial de <span className="text-primary">Alquileres</span>
            </h1>
          </div>
        ...
        <div className="space-y-6">
          {loading ? (
            ...
            <Card className="border-2 border-dashed border-border/60 rounded-[3rem] p-20 text-center space-y-6 bg-muted/5">
              ...
              <p className="text-xl font-display font-bold italic text-muted-foreground">No tienes pedidos en esta categoría todavía.</p>
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-6 p-6 sm:p-8">
                        ...
                        <div className="flex-1 space-y-2 text-center sm:text-left">
                          ...
                          <h4 className="text-xl font-display font-bold">
                            {order.rentals.length > 1 ? "Combo Folclórico Premium" : order.rentals[0].product_id?.name}
                          </h4>
                        ...
                        <div className="shrink-0 flex items-center gap-2">
                          ...
                          >
                            Detalles <Info className="h-4 w-4 ml-2 opacity-40" />
                          </Button>
                        </div>
                      </div>
                    </CardContent>
            ...
            <div className="flex flex-col max-h-[85vh]">
              ...
              <div className="p-8 border-b border-border/10 bg-muted/20">
                ...
                <DialogDescription className="text-muted-foreground font-medium mt-1">
                  Pedido realizado el {selectedOrder.date.toLocaleDateString()}
                </DialogDescription>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-10 no-scrollbar">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                  <div className="space-y-4">
                    <h5 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Información del Periodo</h5>
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        <Calendar className="h-5 w-5 text-primary shrink-0" />
                        <div className="space-y-1">
                          <p className="text-sm font-bold">Reserva de Fechas</p>
                          <p className="text-xs text-muted-foreground leading-relaxed">
                            {new Date(selectedOrder.rentals[0].start_date).toLocaleDateString()} al {new Date(selectedOrder.rentals[0].end_date).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1">
                          <p className="text-sm font-bold">Política de Retorno</p>
                          <p className="text-xs text-muted-foreground leading-relaxed">Las piezas deben ser entregadas antes del mediodía de la fecha final para evitar cargos adicionales.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <h5 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Resumen Financiero</h5>
